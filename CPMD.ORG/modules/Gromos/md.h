...
C the 4D switch is separate
      ...
      real*8 TEMP0,TAUT,PRES0,COMP,TAUP
      COMMON /MBEREF/
...
C plist block
      ...
      real*8 RCUTP,RSWI2,RCUT2,CELM,RCUTL
...
C fourdim block
     ...
     $     NDO4D(MX4DIN),NTCW4D,NT4XI,NT4XO
      ...
      real*8 CW4DA,TEMP4I,TEMP04,TAUT4,CW4DB,TEMP0B
