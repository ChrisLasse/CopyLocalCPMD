...
cmb      PARAMETER (MAXINB = 320000)
cmb      PARAMETER (MAXJNB = 18000000)
...
cmb      PARAMETER (MXATCG = 40,MAXLAT = MXATCG*MAXDIM)
      PARAMETER (MXATCG=240,MAXLAT=MXATCG*MAXDIM)
COMMEND
...
C
      ...
      PARAMETER (MNCONT = IPBH)
COMMEND
      INTEGER IPKW
      PARAMETER (IPKW = MXNRGF+13)
      PARAMETER (MXCONT = IPKW)
